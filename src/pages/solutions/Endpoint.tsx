...
export default function EndpointSolution() {
  return (
    <PageLayout>
      <section className="py-16 lg:py-20 relative z-10">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            Reduce endpoint risk with practical hardening, detection coverage, and operational response playbooks.
          </motion.p>
            ...
            {[
              {
                ...
                text: "Standardize secure configurations and reduce attack surface across devices and users.",
              },
              {
                title: "Detection Coverage",
                text: "Improve alert quality and response steps aligned to your IT and SOC workflows.",
              },
              {
                title: "Operational Readiness",
                text: "Define escalation paths, incident triage, and recovery procedures that teams can execute.",
              },
            ].map((item) => (
              <div
                key={item.title}
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3">
            <Button asChild>
              <Link to="/contact">Discuss Your Environment</Link>
            </Button>
