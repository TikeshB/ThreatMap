...
export default function SecurityAuditService() {
  return (
    <PageLayout>
      <section className="py-16 lg:py-20 relative z-10">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            Get a clear view of your current security posture. We assess controls, identify gaps, and provide a
            ...
            {[
              {
                ...
                text: "Assess policies, configuration, and operations against risk and requirements.",
              },
              {
                title: "Gap Analysis",
                text: "Highlight weaknesses across identity, cloud, endpoints, and applications.",
              },
              {
                title: "Action Plan",
                text: "Provide prioritized remediation steps with owners and timelines.",
              },
            ].map((item) => (
              <div
                key={item.title}
