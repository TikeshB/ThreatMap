    ...
    <PageLayout>
      <section className="py-16 lg:py-20 relative z-10">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            Prepare, respond, and recover faster. We help teams build incident processes and run exercises so response
            is calm, coordinated, and measurable.
          </motion.p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              {
                title: "Readiness",
                text: "Roles, escalation, evidence handling, and communication paths.",
              },
              {
                title: "Tabletop Exercises",
                text: "Scenario-driven drills to improve decisions under pressure.",
              },
              {
                title: "Post-Incident Learning",
                text: "Root-cause analysis and improvements to prevent repeat events.",
              },
            ].map((item) => (
              <div
                key={item.title}
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3">
            <Button asChild>
              <Link to="/contact">Engage IR Support</Link>
            </Button>
